...
jsPsych.plugins['html-slider-response-luc'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-slider-response-luc',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.require_movement){
      display_element.querySelector('#jspsych-html-slider-response-response').addEventListener('click', function(){
        ...
        var respTime = performance.now();
        response.rt_confidence = respTime - startTime;
      })
    } else {
    ...
    function end_trial(){
      ...
      response.rt = endTime - startTime;
      response.response = display_element.querySelector('#jspsych-html-slider-response-response').value;
      if (response.rt_confidence == null) {
        response.rt_confidence = response.rt
      }

      jsPsych.pluginAPI.clearAllTimeouts();
      // save data
      var trialdata = {
        "rt_confirm": response.rt,
        "response": response.response,
        "rt_choice": response.rt_confidence,
